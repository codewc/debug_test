                        ...
                        if (datalist.length > 1) {
                            ...
                            for (var i = 1; i < datalist.length; i++) {
                                ...
                                var li = $("<div class=\"dataItem\">"
                                    ...
                                    + "<a href='" + linkA + "' target='_blank' style='color:Black; text-decoration:none'>" + title + "</a>"
                                    + "</div>"
                                    + "</td>"
                                    + "</tr>"
                                    + "<tr>"
                                    ...
                                    + "</div>"
                                    + "<div class=\"download\">"
                                    + "<img style=\"cursor:pointer;\" title='下载' onclick=\"DownLoadCase('" + key + "|" + title.replace('<span style=\'color:red\'>', '').replace('</span>', '') + "|" + judgeDate + "');\" src=\"/Assets/img/list/list_download.png\" alt=\"下载\"/>"
                                    + "</div>"
                                    + "<div class=\"collect\">"
                                    + "<img style=\"cursor:pointer;\" title='收藏'  onclick=\"CollectCase('" + key + "','" + title.replace('<span style=\'color:red\'>', '').replace('</span>', '') + "','" + caseCourt + "','" + caseNumber + "','" + judgeDate + "');\" src=\"/Assets/img/list/list_collect.png\"  alt=\"收藏\"/>"
                                    + "</div>"
                                    + "</div>"
                                    + "</div>");
